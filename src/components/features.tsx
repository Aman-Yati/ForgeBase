        ...
        <div>
          ...
          <div className="mx-auto max-w-3xl pb-4 text-center md:pb-12">
            ...
            <p className="text-lg text-indigo-200/65">
              Manage applications, interviews, offers, and rejections from onebeautiful dashboard. Stay organized and focus on landing your next role.
            </p>
          </div>
          ...
          <div className="mx-auto grid max-w-sm gap-12 sm:max-w-none sm:grid-cols-2 md:gap-x-14 md:gap-y-16 lg:grid-cols-3">
            ...
            <article>
              ...
              <p className="text-indigo-200/65">
                Create personalized tags, notes, priorities, and workflows that match your own application process.              </p>
            </article>
            <article>
              <svg
                className="mb-3 fill-indigo-500"
