  ...
  return (
    ...
    >
      <div className="flex flex-col gap-4">
        <div>
          <Image src={testimonial.clientImg} height={36} width={36}alt="Client logo" />
        </div>
